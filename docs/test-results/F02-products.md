...
- 실행 일시: 2026-09-07T10:56:23.400464+09:00
- 환경: Windows-11-10.0.26200-SP0, Python 3.12.14
- 기준 커밋: 1d74e93 + 해당 기능 작업 트리
- 실행 위치: backend
- 실행 명령: `python -m pytest -v tests/test_products.py tests/test_api.py`
- 종료 코드: 0
- 결과: PASS
- 소요 시간: 1.56초
...
tests/test_products.py::test_catalog_search_and_health PASSED            [ 11%]
tests/test_products.py::test_unknown_product_is_not_free PASSED          [ 22%]
tests/test_products.py::test_estimate_empty_and_invalid PASSED           [ 33%]
tests/test_products.py::test_swagger_contract PASSED                     [ 44%]
